...
//  UrbanClap Replica
//
//  Created by Mohit Sharma on 5/5/20.
...
class SocketHelper
{
    ...
    let manager = SocketManager(socketURL: URL(string: APIAddress.SOCKET_BASE_URL)!, config: [.log(true), .compress])
    ...
    enum Events
    {
        ...
        {
//            SocketHelper.shared.socket.on(listnerName)
//            { (response, emitter) in
//                completion(response)
//            }
